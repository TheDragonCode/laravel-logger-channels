...
<picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://banners.beyondco.de/Laravel%20Logger%20Channels.png?pattern=topography&style=style_2&fontSize=100px&md=1&showWatermark=1&theme=dark&packageManager=composer+require&packageName=andrey-helldar%2Flaravel-logger-channels&description=Set+of+custom+loggers+for+Monolog+in+Laravel&images=https%3A%2F%2Fwww.php.net%2Fimages%2Flogos%2Fnew-php-logo.svg">
    <img src="https://banners.beyondco.de/Laravel%20Logger%20Channels.png?pattern=topography&style=style_2&fontSize=100px&md=1&showWatermark=1&theme=light&packageManager=composer+require&packageName=andrey-helldar%2Flaravel-logger-channels&description=Set+of+custom+loggers+for+Monolog+in+Laravel&images=https%3A%2F%2Fwww.php.net%2Fimages%2Flogos%2Fnew-php-logo.svg" alt="Laravel Logger Channels">
</picture>
